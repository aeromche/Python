...
def points():
    ...
    label_player_one = tk.Label(board_frame, text="بازیکن 1", font=("Traffic",16), padx=10)
    label_player_two = tk.Label(board_frame, text="بازیکن 2", font=("Traffic",16), padx=10)
    ...
    point_player_one = tk.Label(point_frame, text=player_points[0], padx=20, font=("Traffic", 18))
    point_player_two = tk.Label(point_frame, text=player_points[1], padx=20, font=("Traffic", 18))
